...
namespace Simple_Shop.Events
{
    // https://gist.github.com/jbogard/54d6569e883f63afebc7
    // http://lostechies.com/jimmybogard/2014/05/13/a-better-domain-events-pattern/
    // This is based on the above links, but updated slightly to support .NET Core's built in DI container
    internal class DomainEventDispatcher : IDomainEventDispatcher
    {
        ...
        public IEnumerable<DomainEventHandler> GetWrappedHandlers(BaseDomainEvent domainEvent)
        {
            ...
            IEnumerable handlers = (IEnumerable)provider.GetService(typeof(IEnumerable<>).MakeGenericType(handlerType));
